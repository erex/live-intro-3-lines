...
date: Demonstration--two stages of model selection <br> September 2020
output:
...
For this demonstration, I require a data set with an interesting shape to the histogram.  I will not describe the data set, other than to note it contains roughly 1000 detections.  We will see this data set again next week.
...
<div class="collapse" id="collapseExample">
  <h5 class="card-title">Goodness of fit, half normal cosine</h5>
  <div class="card card-block card text-white bg-warning mb-3" style="max-width: 75rem;">
